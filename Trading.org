...
- [[#suspension-block-is-an-isolated-candlestic-that-algorism-letter-comes-to-it][Suspension block is an isolated candlestic that algorism letter comes to it.]]
- [[#wicks][Wicks]]
...
* Suspension block is an isolated candlestic that algorism letter comes to it.
** It is an isolated candlestic which has volume imbalance (fvg) below it and volume imbalance (fvg) above it.

* Wicks
** The algorithm sees wick as gaps and treat it as a gap.
** When you see long wick that created a turning point a lot of folks look at if they are bullish, they are going to see that low is support and that support is broken.
** Look as half of that wick and the upper quadrant; those are the most sensitive price points when you are bullish. The opposite true for wicks of bearish. 
